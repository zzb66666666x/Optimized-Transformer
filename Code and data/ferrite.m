function [Efficiency,Powerdensity,Tcalmax]=ferrite(V1,V2,n,Viso,Nratio,Pout,f,Tmax,nc,Acore,ds1,ds2,m1,Nl1,Jmax)
    ...
    Rth35=dcl1/(3*2*2*Gcore*Bcore*kepoxy);
    Rth34=diso/(Bcore*hw*kbobbin);
    Rth45=dcl2/(3*2*(hw*Bcore+2*W2*Bcore)*kepoxy);
    Rth25=dcl2/(3*2*(Height*Bcore+2*Gcore*Bcore)*kepoxy);
    Rth2a=Acore/(3*2*(Height+2*Acore)*Bcore*knano);
    Q4=Psec*Bcore/MLT2;
    Q3=Ppri*Bcore/MLT1;
    Q2=(3*Pcore)/(4*nc*2);
    Q1=Pcore/(4*nc*2);
