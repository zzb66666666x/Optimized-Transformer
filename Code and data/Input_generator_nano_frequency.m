...
%store the result
fid=fopen(".\Try_Different_Frequencies\result_nano_frequency_112KW.csv","w");
       ...
       for Jmax_pointer=1:1:5
          for m1Nl1_pointer=1:1:Number_elements
              for f_pointer = 1:1:4
                ...
                [efficiency,powerdensity,Tmax]=nano(1026,775,45/34,30000,45/34,112e3,f*1000,400,nc,Acore/100,ds1,ds2,m1,Nl1,Jmax*1e6);
                deltaT=Tmax-300;
